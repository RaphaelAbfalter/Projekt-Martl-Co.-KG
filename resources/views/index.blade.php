    ...
    <body>
        <div class="flex flex-column">
            ...
            <div class="startpage-header">
                <!--style="background-image: url(https://bslinz2.sharepoint.com/:i:/r/sites/2022-23_3aAPC_PP/Kursmaterialien/bilder_martl_automationstechnik/martl_cokg.png?csf=1&web=1&e=KdhsYB);
